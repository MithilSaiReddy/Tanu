"""
tanu/connections — Messaging gateway channels.
...
─────────────────────
1. Create tanu/connections/slack.py  (or matrix.py, whatsapp.py, …)
...
def get_telegram_channel():
    ...
    from tanu.connections.telegram import TelegramChannel
    return TelegramChannel


def get_discord_channel():
    """Lazy import — only loads when actually needed."""
    from tanu.connections.discord import DiscordChannel
